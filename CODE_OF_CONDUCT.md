...
education, or other status. The same privileges of participation are extended to everyone
...
violation, use GitHub's private vulnerability reporting, the same private channel described
in [SECURITY.md](SECURITY.md):
**https://github.com/javierbeaumont/minimoni/security/advisories/new**
...
2. Temporarily Limited Activities
   ...
   2. Consequence: A private, written warning with a time-limited cooldown period designed to
      underscore the seriousness of the situation and give the community members involved
