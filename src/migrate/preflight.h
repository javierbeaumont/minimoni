 ...
 *   - PRAGMA application_id is the moni magic 0x6D6F6E69 (1836019305
 *     decimal). minimoni stamps it on every database since v0.1, so any
 *     other value (including 0) means the file belongs to a different
 *     application.
